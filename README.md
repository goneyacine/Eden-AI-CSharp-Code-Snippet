...
<a name="question-answering"></a>
   * ### Quickstart with Question Answering API
   #### POST : https://api.edenai.run/v2/text/question_answer
...
```
<a name="pii"></a>
  * ### Quickstart with PII and Anonymization API
    #### POST : https://api.edenai.run/v2/text/anonymization
...
```
<a name="custom-text-classification"></a>

 * ### Quickstart with Custom Text Classification API
   #### POST : https://api.edenai.run/v2/text/custom_classification
